...
// Input
confirm_key = keyboard_check_pressed(ord("E")); // button to press to go to the next page
...
portrait_sprite = -1;
portrait_width = sprite_get_width(spr_portraits);
portrait_height = sprite_get_height(spr_portraits);
...
speaker_name = "";
speaker_width = sprite_get_width(spr_namebox);
speaker_height = sprite_get_height(spr_namebox);
