...
if (sprite_exists(portrait_sprite)) {
	...
	draw_sprite(spr_portraits, 0, draw_portrait_x, draw_portrait_y);
...
if (speaker_name != "") {
	...
	draw_sprite_stretched(spr_namebox, 0, x + speaker_x, y + speaker_y - speaker_height / 2, name_w, speaker_height);
